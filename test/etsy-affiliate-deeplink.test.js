...
function product(id, overrides = {}) {
  ...
  return { id: `db-${id}`, source: "etsy", external_listing_id: id, etsy_feed_provenance: "creator_storefront", bingo_collection: "THE WALK", listing_url: clean, original_listing_url: clean, admin_status: "review", public_visibility: 0, affiliate_review_status: "draft", ...overrides };
}
